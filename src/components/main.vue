<template>
	<div class="main">
		...
		<Tabbar icon-class="icon-class" @on-index-change="func4">
			<TabbarItem :link="{name:'home'}" icon-class="icon-class" selected >
				...
				<span slot="label"><span>首页</span></span>
			</TabbarItem>
			<TabbarItem :link="{name:'order'}" >
